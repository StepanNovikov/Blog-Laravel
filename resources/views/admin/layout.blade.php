...
<head>
  ...
  <link rel="stylesheet" href="/Blog-Laravel/public/css/admin.css">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="/Blog-Laravel/public/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="/Blog-Laravel/public/img/user2-160x160.jpg" class="user-image" alt="User Image">
...
<!-- ./wrapper -->
<script src="/Blog-Laravel/public/js/admin.js"></script>
</body>
